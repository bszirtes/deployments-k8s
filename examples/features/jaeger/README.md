...
Apply Jaeger pod:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/jaeger/jaeger?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/jaeger/opentelemetry?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```

Apply Spire deployments (required for NSM system)
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/spire/single_cluster?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
...
Apply NSM resources:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/jaeger/nsm-system?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
