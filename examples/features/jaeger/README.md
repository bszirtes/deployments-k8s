...
Apply Jaeger pod:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/jaeger/jaeger?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56
```
...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/jaeger/opentelemetry?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56
```
...
Apply NSM resources:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/jaeger/nsm-system?ref=0e8c3ce7819f0640d955dc1136a64ecff2ae8c56
```
