...
Apply Jaeger pod:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/jaeger/jaeger?ref=v0.1.30
```
...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/jaeger/opentelemetry?ref=v0.1.30
```

Apply Spire deployments (required for NSM system)
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/spire/single_cluster?ref=v0.1.30
```
...
Apply NSM resources:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/jaeger/nsm-system?ref=v0.1.30
```
