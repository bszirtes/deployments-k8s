...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/dual-stack/Kernel2Kernel_dual_stack?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
