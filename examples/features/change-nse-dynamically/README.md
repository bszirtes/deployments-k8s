...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/features/change-nse-dynamically?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```

```bash
kubectl apply -f https://github.com/networkservicemesh/deployments-k8s/0e8c3ce7819f0640d955dc1136a64ecff2ae8c56/examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f https://github.com/networkservicemesh/deployments-k8s/0e8c3ce7819f0640d955dc1136a64ecff2ae8c56/examples/features/change-nse-dynamically/green-netsvc.yaml
```
