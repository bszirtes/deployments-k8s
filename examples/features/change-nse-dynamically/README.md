...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/features/change-nse-dynamically?ref=204e2ec919848d7fea28075f63db3c23089e0c90
```

```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/204e2ec919848d7fea28075f63db3c23089e0c90/examples/features/change-nse-dynamically/blue-netsvc.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/204e2ec919848d7fea28075f63db3c23089e0c90/examples/features/change-nse-dynamically/green-netsvc.yaml
```
