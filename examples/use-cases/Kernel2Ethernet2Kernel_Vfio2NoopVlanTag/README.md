...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2Ethernet2Kernel_Vfio2NoopVlanTag?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
