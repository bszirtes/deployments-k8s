...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-1?ref=v0.1.35
```
...
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-2?ref=v0.1.35
```

Deployment in third namespace:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/Kernel2RVlanMultiNS/ns-3?ref=v0.1.35
```
