...
Deploy ponger:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/SriovKernel2NoopVlanTag/ponger?ref=v0.1.39
```
...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/SriovKernel2NoopVlanTag?ref=v0.1.39
```
