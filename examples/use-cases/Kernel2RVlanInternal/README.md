...
```bash
kubectl apply -k https://github.com/networkservicemesh/deployments-k8s/examples/use-cases/Kernel2RVlanInternal?ref=844c34f949e635a8d957d77cb7bbcf0120384047
```
