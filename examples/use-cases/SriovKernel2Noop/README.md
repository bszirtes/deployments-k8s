...
Deploy ponger:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/SriovKernel2Noop/ponger?ref=v0.1.32
```
...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/use-cases/SriovKernel2Noop?ref=v0.1.32
```
