...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-restart/registry-before-death?ref=16c95000d6830e7e9a8cb20b2cf6b5f912c467fb
```
...
Apply a new client:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-restart/registry-after-death?ref=16c95000d6830e7e9a8cb20b2cf6b5f912c467fb
```
