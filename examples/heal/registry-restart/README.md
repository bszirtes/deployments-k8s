...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-restart/registry-before-death?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
...
Apply a new client:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-restart/registry-after-death?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
