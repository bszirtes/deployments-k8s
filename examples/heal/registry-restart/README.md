...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-restart/registry-before-death?ref=v0.1.36
```
...
Apply a new client:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-restart/registry-after-death?ref=v0.1.36
```
