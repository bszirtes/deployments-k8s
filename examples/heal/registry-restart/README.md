...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-restart/registry-before-death?ref=ce845a16f06e25a97be64723da300c7f92a730f0
```
...
Apply a new client:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-restart/registry-after-death?ref=ce845a16f06e25a97be64723da300c7f92a730f0
```
