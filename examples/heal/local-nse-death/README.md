...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/local-nse-death/nse-before-death?ref=v0.1.35
```
...
Apply patch:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/local-nse-death/nse-after-death?ref=v0.1.35
```
