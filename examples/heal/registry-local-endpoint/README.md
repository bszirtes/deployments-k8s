...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-local-endpoint/nse-first?ref=v0.1.42
```
...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/registry-local-endpoint/nse-second?ref=v0.1.42
```
