...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/remote-nse-death/nse-before-death?ref=v0.1.41
```
...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/remote-nse-death/nse-after-death?ref=v0.1.41
```
