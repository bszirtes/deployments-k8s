...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/remote-nse-death-ip/nse-before-death?ref=v0.1.44
```
...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/remote-nse-death-ip/nse-after-death?ref=v0.1.44
```
