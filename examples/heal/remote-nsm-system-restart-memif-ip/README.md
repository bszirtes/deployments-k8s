...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/remote-nsm-system-restart-memif-ip?ref=v0.1.31
```
...
```
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/basic?ref=v0.1.31
```
