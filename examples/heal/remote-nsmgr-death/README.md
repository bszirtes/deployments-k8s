...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/remote-nsmgr-death/remote-nse?ref=v0.1.40
```
...
Kill remote NSMgr:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/remote-nsmgr-death/nsmgr-death?ref=v0.1.40
```

Start local NSE instead of the remote one:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/heal/remote-nsmgr-death/local-nse?ref=v0.1.40
```
...
Restore NSMgr setup:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/apps/nsmgr?ref=v0.1.40 -n nsm-system
```
