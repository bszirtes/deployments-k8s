...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/observability/jaeger_and_prometheus?ref=v0.1.30
```
...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/observability/jaeger_and_prometheus/example?ref=v0.1.30
```
