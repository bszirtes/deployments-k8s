...
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/observability/jaeger_and_prometheus?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
...
Deploy NSC and NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/observability/jaeger_and_prometheus/example?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
