...
1. Start vl3
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/networkservicemesh/deployments-k8s/examples/interdomain/usecases/nsm_kuma_universal_vl3/vl3-dns?ref=da20e3b2619ec0ea9c9e459e3a6f4fa12eeae70b
...
```
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/da20e3b2619ec0ea9c9e459e3a6f4fa12eeae70b/examples/interdomain/usecases/nsm_kuma_universal_vl3/namespace.yaml
...
patches:
- path: https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/da20e3b2619ec0ea9c9e459e3a6f4fa12eeae70b/examples/interdomain/usecases/nsm_kuma_universal_vl3/patch-control-plane.yaml
EOF
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/da20e3b2619ec0ea9c9e459e3a6f4fa12eeae70b/examples/interdomain/usecases/nsm_kuma_universal_vl3/demo-redis.yaml
...
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -f https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/da20e3b2619ec0ea9c9e459e3a6f4fa12eeae70b/examples/interdomain/usecases/nsm_kuma_universal_vl3/demo-app.yaml
