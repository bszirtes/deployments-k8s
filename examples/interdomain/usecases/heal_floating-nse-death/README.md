...
Deploy NS:
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/heal_floating-nse-death/cluster3?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/heal_floating-nse-death/cluster2?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
...
Deploy NSC:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/heal_floating-nse-death/cluster1?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
