...
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/nsm_consul_vl3/cluster1?ref=aaf1e1522fbe81126acda26e7d83cb3571fd3baa
```

```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/nsm_consul_vl3/cluster2?ref=aaf1e1522fbe81126acda26e7d83cb3571fd3baa
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG1 delete -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/nsm_consul_vl3/cluster1?ref=aaf1e1522fbe81126acda26e7d83cb3571fd3baa
```

```bash
kubectl --kubeconfig=$KUBECONFIG2 delete -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/nsm_consul_vl3/cluster2?ref=aaf1e1522fbe81126acda26e7d83cb3571fd3baa
```
