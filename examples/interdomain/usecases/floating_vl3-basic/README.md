...
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/floating_vl3-basic/cluster3?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```

Deploy a vl3-NSE and a client on the cluster1:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/floating_vl3-basic/cluster1?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```

Deploy a vl3-NSE and a client on the cluster2:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/floating_vl3-basic/cluster2?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
...
```bash
kubectl --kubeconfig=$KUBECONFIG3 delete -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/floating_vl3-basic/cluster3?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```

Cleanup cluster2 domain:
```bash
kubectl --kubeconfig=$KUBECONFIG2 delete -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/floating_vl3-basic/cluster2?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```

Cleanup cluster1 domain:
```bash
kubectl --kubeconfig=$KUBECONFIG1 delete -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/floating_vl3-basic/cluster1?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
