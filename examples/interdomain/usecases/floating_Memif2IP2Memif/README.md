...
Deploy NS:
```bash
kubectl --kubeconfig=$KUBECONFIG3 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/floating_Memif2IP2Memif/cluster3?ref=v0.1.43
```
...
Deploy NSE:
```bash
kubectl --kubeconfig=$KUBECONFIG2 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/floating_Memif2IP2Memif/cluster2?ref=v0.1.43
```
...
Deploy NSC:
```bash
kubectl --kubeconfig=$KUBECONFIG1 apply -k https://github.com/bszirtes/deployments-k8s/examples/interdomain/usecases/floating_Memif2IP2Memif/cluster1?ref=v0.1.43
```
