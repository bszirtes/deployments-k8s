...
```bash
curl https://raw.githubusercontent.com/networkservicemesh/deployments-k8s/c67cc13656aac2afb2743969032a6439a6f841a6/apps/nse-simple-vl3-docker/docker-compose.yaml -o docker-compose.yaml
```
