...
Deploy NSC:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/k8s_monolith/external_nse/usecases/Kernel2IP2Kernel?ref=98d12834ac8b2af512570763c7d6eccb2151f778
```
