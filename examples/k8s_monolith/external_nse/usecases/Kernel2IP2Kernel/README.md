...
Deploy NSC:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/k8s_monolith/external_nse/usecases/Kernel2IP2Kernel?ref=ce845a16f06e25a97be64723da300c7f92a730f0
```
