...
Deploy NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/k8s_monolith/external_nsc/usecases/Kernel2IP2Kernel?ref=aaf1e1522fbe81126acda26e7d83cb3571fd3baa
```
