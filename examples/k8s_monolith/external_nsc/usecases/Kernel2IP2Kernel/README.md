...
Deploy NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/k8s_monolith/external_nsc/usecases/Kernel2IP2Kernel?ref=16c95000d6830e7e9a8cb20b2cf6b5f912c467fb
```
