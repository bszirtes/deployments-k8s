...
Deploy NSE:
```bash
kubectl apply -k https://github.com/bszirtes/deployments-k8s/examples/k8s_monolith/external_nsc/usecases/Kernel2IP2Kernel?ref=b65aec2b2cbf74adb05b5e3796a3ed7dcd6358a4
```
